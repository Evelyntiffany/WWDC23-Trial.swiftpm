...
struct Josh7: View {
    var body: some View {
        ZStack {
            ...
            Text(" \"Let me make it up to you. Here, have some candies.\" ")
            ...
            Button(action: {}){
                VStack {
                    NavigationLink(destination: Josh8()){
...
struct Josh7_Previews: PreviewProvider {
    static var previews: some View {
        Josh7().previewInterfaceOrientation(.landscapeRight)
    }
}
